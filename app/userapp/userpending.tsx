                            ...
                            router.push({
                                ...
                                params: {
                                    serviceData: JSON.stringify({
                                        clientName: completedService.clientName,
                                        phone: completedService.phone,
                                        serviceType: completedService.serviceType,
                                        amount: completedService.amount,
                                        serviceDate: completedService.serviceDate,
                                        serviceTime: completedService.serviceTime,
                                        serviceBoy: completedService.serviceBoy,
                                        completedAt: currentTimestamp
                                    })
                                }
                            });
